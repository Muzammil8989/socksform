        ...
        <>
            <section className='h-screen w-full lg:w-11/12 grid grid-cols-1 lg:grid-cols-2 gap-3 lg:gap-5 items-center  font-[Montserrat]'>
                ...
                <div className='col-span-1 w-full h-auto lg:h-[50vh] grid grid-cols-1 lg:grid-cols-2 gap-3 p-5 overflow-visible'>
                  <motion.div
                        className="col-span-1 rounded-lg shadow-2xl p-5 flex flex-col justify-center gap-y-3 bg-red-100 font-[Montserrat]"
                        initial={{ y: -250, opacity: 0 }}
                        animate={{ y: 0, opacity: 1 }}
                        transition={{ type: 'spring', stiffness: 50, damping: 10 }}
                    >
                     <p className='text-lg 2xl:text-2xl font-semibold text-[#BE261F]'>Request Free Designs:</p>
                     <p className='bg-slate-200 text-black w-1/2 py-1 text-center rounded-full font-bold text-sm'>Get Design in 24 Hours</p>
                     <p>
                    ...
                    >
                     ...
                     <p className='bg-slate-200 text-black w-1/2 py-1 text-center rounded-full font-bold text-sm'>Design your Own</p>
                     <p>
